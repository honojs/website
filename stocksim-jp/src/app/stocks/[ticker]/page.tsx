    ...
    <div className='space-y-6'>
      <div className='space-y-1'>
        <div className='flex items-center gap-3 flex-wrap'>
          ...
          <Badge variant={quote.marketState === 'REGULAR' ? 'gain' : 'secondary'}>
      ...
      <div className='grid gap-6 lg:grid-cols-3'>
        <div className='lg:col-span-2 space-y-6'>
          ...
          {info?.description && (
            <Card>
              <CardHeader><CardTitle className='text-base'>企業概要</CardTitle></CardHeader>
          ...
          {news.length > 0 && (
            <Card>
              <CardHeader><CardTitle className='text-base'>最新ニュース</CardTitle></CardHeader>
